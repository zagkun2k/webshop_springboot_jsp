...
<c:set var="cart" value="${sessionScope['scopedTarget.cartService']}" />
              ...
              <div id="demo" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="/static/images/slideshow/slide2.jpg" alt="Los Angeles" width="100%" height="300px">
					</div>
	...
	</div><div class="gia-soc" style="margin-top: 30px">
		<div style="background-color: rgb(206, 12, 18); width: 100.1%; margin-left: -1px; height: 65px; margin-top: -10px;  font-weight: bold; padding: 13px">
			<span style="color: #fff; text-align: left; font-size: 26px;">SẢN PHẨM ĐẶC BIỆT</span> 
			<span style="color: #fff; float: right; font-size: 16px; padding: 8px">
				<a href="/product/list-by-special/4" style="color: #fff; text-decoration: none;"> Xem tất cả</a></span>
		</div>
